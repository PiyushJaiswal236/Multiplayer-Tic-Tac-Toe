...
const uri =
  "mongodb+srv://PJ:smgmYzEFd86QyupS@cluster0.zo5xg4u.mongodb.net/?retryWrites=true&w=majority";
...
io.on("connection", (socket) => {
  ...
  socket.on("gridTap", async ({ index, roomId }) => {
    try {
      ...
      if (room.filledBoxes > 2) {
        if (
          room.displayElements[0] == room.displayElements[1] &&
          room.displayElements[0] == room.displayElements[2] &&
          room.displayElements[0] != ""
        ) {
          console.log("1");
          ...
          room.displayElements[3] == room.displayElements[4] &&
          room.displayElements[3] == room.displayElements[5] &&
          room.displayElements[3] != ""
        ) {
          console.log("2");
          room.player[room.turnIndex].points++;
          await room.save();
          ...
          room.displayElements[6] == room.displayElements[7] &&
          room.displayElements[6] == room.displayElements[8] &&
          room.displayElements[6] != ""
        ) {
          console.log("3");
          room.player[room.turnIndex].points++;
          await room.save();
          ...
          room.displayElements[0] == room.displayElements[4] &&
          room.displayElements[0] == room.displayElements[8] &&
          room.displayElements[0] != ""
        ) {
          console.log("4");
          room.player[room.turnIndex].points++;
          ...
          room.displayElements[2] == room.displayElements[4] &&
          room.displayElements[2] == room.displayElements[6] &&
          room.displayElements[2] != ""
        ) {
          console.log("5");
          room.player[room.turnIndex].points++;
          await room.save();
          ...
          room.displayElements[0] == room.displayElements[3] &&
          room.displayElements[0] == room.displayElements[6] &&
          room.displayElements[0] != ""
        ) {
          console.log("6");
          room.player[room.turnIndex].points++;
          ...
          room.displayElements[1] == room.displayElements[4] &&
          room.displayElements[1] == room.displayElements[7] &&
          room.displayElements[1] != ""
        ) {
          console.log("7");
          room.player[room.turnIndex].points++;
          await room.save();
          ...
          room.displayElements[2] == room.displayElements[5] &&
          room.displayElements[2] == room.displayElements[8] &&
          room.displayElements[8] != ""
        ) {
          console.log("8");
          room.player[room.turnIndex].points++;
          await room.save();
  ...
  socket.on("requestReplay", async ({ roomId }) => {
    ...
    try {
      ...
      console.log(
        room.player[0].wantsReplay + " && " + room.player[1].wantsReplay
      );
